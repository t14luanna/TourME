...
function createMarker(place){
  ...
  google.maps.event.addListener(marker, 'click', function() {
    ...
    //   marker.setIcon('../Asset/Icons/' + type + '_default.png');
    // } else {
    //   marker.setIcon('../Asset/Icons/' + type + '_active.png');
    // }
...
function createMainMarker(place){
  ...
  if(type!=null){
    var image = {
      url: '../Asset/Icons/' + type + '_main.png',
      size: new google.maps.Size(71, 71),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(17, 34),
      scaledSize: new google.maps.Size(25, 25)
    ...
    google.maps.event.addListener(marker, 'click', function() {
      // if(tripBook.indexOf(place)>-1) {
      //   marker.setIcon('../Asset/Icons/' + type + '_main.png');
      // } else {
      //   marker.setIcon('../Asset/Icons/' + type + '_main_active.png');
      // }
      showInfo(place,marker,type);
      // addPlace(place);
    });
...
function createTripBookMarker(place){
  ...
  var image = {
    url: '../Asset/Icons/' + type + '_active.png' ,
    size: new google.maps.Size(71, 71),
    origin: new google.maps.Point(0, 0),
    anchor: new google.maps.Point(17, 34),
    scaledSize: new google.maps.Size(25, 25)
